app.controller('showPlayersController', function($scope, auth, $rootScope, notify) {
    ...
    $scope.addPerson = function() {
        ...
        var dataToSend = { token: Cookies.get('tq'), tmid: $rootScope.user.tmid, fname: firstname, lname: lastname, mail: email, isPersonel: ($("#addedIsPersonel").is(':checked')), isAdmin: 'false' };
